...
from models.stock_money_flow_dc import StockMoneyFlowDc
from sqlalchemy import text

class StockMoneyFlowDcRepository(BaseRepository):
    def __init__(self, session):
        super().__init__(StockMoneyFlowDc, session)
    ...
    def batch_upsert(self, data_list):
        ...
        sql = text("""
            INSERT INTO stock_money_flow_dc 
