...
from models.industry_dc_money_flow import IndustryDcMoneyFlow
from sqlalchemy import text

class IndustryDcMoneyFlowRepository(BaseRepository):
    def __init__(self, session):
        super().__init__(IndustryDcMoneyFlow, session)
    ...
    def batch_upsert(self, data_list):
        ...
        sql = text("""
            INSERT INTO industry_dc_money_flow 
